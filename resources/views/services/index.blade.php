...
<div class="container">
    <div class="row">
        <form action="{{ route('services.index') }}">
            ...
            <select name="serviceCity" id="serviceCity">
    ...
    @foreach($services as $service)
        <div class="col-lg-4 col-md-6 col-sd-12 text-center py-4 d-flex flex-column justify-items-center">
            <a href="/services/{{ $service->id }}"><img class="w-100 h-auto py-3" src="/storage/{{ $service->image }}"><h1>{{ $service->serviceName }}</h1></a>
            <a href="/services/user/{{ $service->user_id }}"><h5>Show more from this company</h5></a>
